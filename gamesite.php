    ...
    <div class="container gamessite">
        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <div id="gameresult">
                    ...
                    <form id="submit-form" method="POST">
                        ...
                        <a href="gamesite.php" class="btn">No</a>
                    </form>
                </div>
            ...
            <div class="col-lg-5">
                ...
                <h3>Playingrules</h3>
                <ul>
                    <li>You have 60 seconds reach Hogwarts in the 3 lavel</li>
                    <li>Collect galleons as points, each galleon gives 2 points</li>
                    <li>Help Dobby to continue to the next lavel</li>
                    <li>Aviode the death eater to survive</li>
                    <li>You totale score is galleons + lives + dobby + seconds left</li>
                </ul>
            </div>
        </div>
    </div>
